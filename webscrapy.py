...
campground_id = "232447" # example correponds to Yosemite Upper Pines Campground
...
for campsite in campsite_json['campsites']:
    ...
    if not availabilities:
        ...
        print(all(dawgie == 'Open' for dawgie in availabilities))
        if all(dawgie == 'Open' and not None for dawgie in availabilities):
...
client.messages.create(phones=phone_number, text="NO CAMPSITES!")
